---
name: codify
description: Explicit workflow for writing a settled goal into the project/ spec in one automated pass. Use only when the user explicitly invokes codify, says $codify, or clearly asks to write the settled goal into project/product, project/research, project/design, and project/plan.
---
First use the project-local `$spec-shapes` skill if it is not already in
