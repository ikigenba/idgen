---
name: grillme
description: Explicit workflow for interrogating a proposed goal or plan one question at a time until shared understanding. Use when the user explicitly says grillme, invokes $grillme, or asks to be grilled before codifying a project/ spec change.
---
