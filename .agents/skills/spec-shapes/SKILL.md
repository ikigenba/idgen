---
name: spec-shapes
description: "The project/ spec contracts: authoritative output shapes of product, research, design, and plan; authority boundaries; and hard invariants every writer keeps. Use before discussing, grilling, codifying, or generating workflows that read or write the project/ spec."
---
...
discussion, a `$grillme` interrogation, `$codify`, and the loop-prompt
generator workflows — takes the shapes below from here and restates them nowhere.
