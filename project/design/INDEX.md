...
- **D4** → `project/design/D04.md` — CLI grammar, dispatch & exit-code taxonomy — ids: R-X0NT-UVTW, R-X1VQ-8NKL, R-X33M-MFBA, R-X4BJ-071Z, R-X5JF-DYSO, R-X6RB-RQJD, R-7UL7-PF0O, R-PU67-68HE
...
- **D6** → `project/design/D06.md` — Version, usage text & Makefile — ids: R-XK67-Z7P0, R-XLE4-CZFP, R-XMM0-QR6E
...
- R-XK67-Z7P0 → D6 (`project/design/D06.md`)
